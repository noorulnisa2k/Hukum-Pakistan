...
<body>
    ...
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
            <a href="/">Home</a> » <span class="breadcrumb_last" aria-current="page">Select Area</span>
        </div>
    </nav>

    <?php
    if (isset($_GET['sub-cat-id']) && isset($_GET['cat-name']) && isset($_SESSION["lbs_city"])) {
        $sub_cateID =  $_GET['sub-cat-id'];
        $categoryName = $_GET['cat-name'];
                    ...
                    <div class="container py-lg-5">
                        <div class="grids-area-hny main-cont-wthree-fea row mb-lg-5 mt-4">
                            <div class="col-lg-12 title-content text-center py-4">
                                <h2 style="color: #faa636;">Select Area</h2>
                            </div>


                            <?php
                            $cat_sql = "SELECT * FROM `lbs_areas` WHERE subCat_ID=$sub_cateID AND city = '$city'";
                            ...
                            ?>
                                    <div class="col-lg-3 col-md-6 grids-feature lbs-li">
                                        <a href="lbs-location.php?categoryName= <?php echo $area_name; ?>">
                            ...
                            <?php
                                ...
                                echo("<script>window.location.href='lbs-location.php?categoryName=".$categoryName."';</script>");
                                // header("Location:lbs-location.php");
                            }
                            ?>
                            <br>
                        </div>
